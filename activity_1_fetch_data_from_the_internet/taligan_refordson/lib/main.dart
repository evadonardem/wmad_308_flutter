...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fetch data from the internet Talig-an refordson',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(63, 218, 33, 156)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Fetch data from the internet talig-an refordson'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        child:Row (
          children: [
          NavigationRail(
            backgroundColor: Color.fromARGB(255, 241, 37, 156),
            extended: true,
            elevation: 10,
            destinations: [
            ...
            onDestinationSelected: (int index) {
              if (index !=2){
                ...
                showAboutDialog(
                  ...
                  applicationVersion: 'May 2024| Talig-an Refordson',
                );
              }
            },
            ),
