...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 230, 240, 100)),
        useMaterial3: true,
      ),
              ...
              onDestinationSelected: (int index){
                if(index != 2){
                  ...
                  showAboutDialog(
                    ...
                    applicationVersion: 'May 4, 2024 | WMAD-308 | Ian Albert Canuto',
                  );
                }
...
class _AlbumsPageState extends State<AlbumsPage> {
    ...
    @override
  void initState() {//Ian Albert Canuto
    super.initState();
    albums = fetchAlbums();
  }
