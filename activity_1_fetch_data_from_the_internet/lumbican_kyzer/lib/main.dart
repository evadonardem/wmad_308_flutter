...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fetch data from the internet KyzerPogi',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 75, 138, 231)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Fetch data from the internet KyzerPogi'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        child:Row (
          children: [
          NavigationRail(
            backgroundColor: Color.fromARGB(255, 68, 211, 236),
            extended: true,
            elevation: 10,
            destinations: [
            ...
            onDestinationSelected: (int index) {
              if (index !=2){
                ...
                showAboutDialog(
                  ...
                  applicationVersion: 'May 2024| Lumbican Kyzer',
                );
              }
            },
            ),
