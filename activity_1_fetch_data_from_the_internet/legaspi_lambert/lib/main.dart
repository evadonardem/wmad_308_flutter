...
Future fetchAlbum(int albumID)async{
  ...
  if (response.statusCode == 200) {
    print('Lambert eto ung data nung isang album:');
    final rawData = response.body;
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 1, 9, 119)),
        useMaterial3: true,
      ),
    ...
    return Scaffold(
      ...
      body: Center(
        child: Row(
          children: [
            NavigationRail(
              backgroundColor: Color.fromARGB(255, 80, 88, 1),
              destinations: [
              ...
              onDestinationSelected: (int index){
                if(index != 2){
                  ...
                  showAboutDialog(
                    ...
                    applicationVersion: 'May 2024 | Lambert Legaaspi',
                  );
                }
