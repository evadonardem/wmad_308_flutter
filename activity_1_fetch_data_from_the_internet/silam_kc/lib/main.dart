...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fetch data from the internet Kc.',
      theme: ThemeData(
        
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 73, 184, 204)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Fetch data from the internet Kc.'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(      
        child: Row(
          children: [
         NavigationRail(
          backgroundColor: Color.fromARGB(255, 226, 173, 208),
          //extended: true,
          elevation: 5,
          destinations: [
          ...
          onDestinationSelected: (int index) {
            if (index !=2) {
              ...
              showAboutDialog(
                ...
                applicationVersion: 'May 2024 KC SILAM',
              );
            }
          },
          ),
