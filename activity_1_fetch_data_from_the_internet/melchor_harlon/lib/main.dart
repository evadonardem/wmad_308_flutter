...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fetch data from the internet Harlon Melchor',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 245, 132, 2)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Fetch data from the internet Harlon Melchor'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        child:Row (
          children: [
          NavigationRail(
            backgroundColor: Color.fromARGB(255, 247, 81, 5),
            extended: true,
            elevation: 10,
            destinations: [
            ...
            onDestinationSelected: (int index) {
              if (index !=2){
                ...
                showAboutDialog(
                  ...
                  applicationVersion: 'May 2024|Harlon Melchor',
                );
              }
            },
            ),
