  ...
  Widget build(BuildContext context) {
    ...
    if (appState.isLoggedIn) {
      ...
      return Scaffold(
        ...
        body: const Center(child: Text('Refordson talig-an')),
...
class _RefordsonLoginPageState extends State<RefordsonLoginPage> {
  ...
  late Future refordsonFutureUsers;
  ...
  void initState() {
    ...
    refordsonFutureUsers = fetchUsers();
  }
  ...
  Widget build(BuildContext context) {
    ...
    print('Entered username: $refordsonUsernameEntered');
    print('Entered password: $refordsonPasswordEntered');
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      onChanged: (String refordsonUsername) {
                        print("Eto yung username nya...$refordsonUsername");
                        setState(() {
                    ...
                    TextFormField(
                      ...
                      onChanged: (String refordsonPassword) {
                        print("Eto yung password nya...$refordsonPassword");
                        setState(() {
                    ...
                    ElevatedButton(
                      style: style,
                      onPressed: () {
                        refordsonFutureUsers.whenComplete(() {
                          print('List of Users loaded');
                        }).then((users) {
                          print('Username to be checked: $refordsonUsernameEntered');
                          print('Password to be checked: $refordsonPasswordEntered');
                          print('List of Users: $users');
                          final bool isValidUser = users
                              .where((user) =>
                                  (user.username == refordsonUsernameEntered ||
                                      user.email == refordsonUsernameEntered))
                              .isNotEmpty;
          ...
          SizedBox(height: 10),
          Text('My sample login page by Refordson'),
        ],
      ),
    );
  }
