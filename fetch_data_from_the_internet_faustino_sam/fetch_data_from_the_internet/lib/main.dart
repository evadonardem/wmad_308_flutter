...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fetch data from the internet Sam',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 186, 218, 7)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Fetch data from the internet Sam'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        child:Row (
          children: [
          NavigationRail(
            backgroundColor: Color.fromARGB(255, 187, 116, 35),
            extended: true,
            elevation: 10,
            destinations: [
            ...
            onDestinationSelected: (int index) {
              if (index !=2){
                ...
                showAboutDialog(
                  ...
                  applicationVersion: 'May 2024| Faustino, Sam',
                );
              }
            },
            ),
